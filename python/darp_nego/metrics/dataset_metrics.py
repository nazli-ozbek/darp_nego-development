...
def build_feature_vectors(case_metrics: pd.DataFrame, company_metrics: pd.DataFrame) -> pd.DataFrame:
    ...
    company_stats = company_grouped.agg(
        ...
        mean_company_avg_distance=("avg_pairwise_distance", "mean"),
        std_company_avg_distance=("avg_pairwise_distance", "std"),
        mean_company_min_distance=("min_pairwise_distance", "mean"),
        std_company_min_distance=("min_pairwise_distance", "std"),
        mean_company_max_distance=("max_pairwise_distance", "mean"),
        std_company_max_distance=("max_pairwise_distance", "std"),
