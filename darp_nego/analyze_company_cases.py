...
def main():
    ...
    file_path = "scenario_generation/data/2025_08_08_14_02_time_windows_overlap/company_cases.json"
    ...
    df, summary_stats = create_visualizations(analysis_results)
    
    print("\n" + "="*60)
    print("COMPANY CASES ANALYSIS COMPLETE")
    print("="*60)
    print(f"Total cases analyzed: {len(df)}")
    print(f"Output directory: company_cases_analysis/")
